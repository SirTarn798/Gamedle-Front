...
export function LoginForm() {
  ...
  return (
    <form action={loginAction} className="w-4/12 bg-mainTheme bg-opacity-50 p-6 rounded-lg text-white">
      ...
      <div className="flex-col items-center justify-center">
        {state?.errors?.email && (
          <div className="mt-6 text-red-500 place-self-center">{state.errors.email}</div>
        )}
        {state?.errors?.password && (
          <div className="text-red-500 place-self-center">{state.errors.password}</div>
        )}
